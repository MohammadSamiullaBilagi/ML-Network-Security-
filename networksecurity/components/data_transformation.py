...
class DataTransformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        '''
        It inititates kNN imputer object with parameters specified in training_pipeline.py file
        and returns pipeline object with kNN imputer object as the first step
        ...
        try:
            #this double star indicates the data is in key-value pairs
